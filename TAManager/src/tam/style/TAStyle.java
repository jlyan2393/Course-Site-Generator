...
public class TAStyle extends AppStyleComponent {
    ...
    public static String DEFAULT_TAB_PANE_STYLE = "default_tab_pane";
    public static String DEFAULT_INNER_PANE_STYLE = "default_inner_pane";
    public static String HEADER_LABEL_STYLE = "header_label_pane";
    public static String SMALL_HEADER_LABEL_STYLE = "small_header_label_pane";
    public static String COMBOBOX_PANE_STYLE = "combobox_pane";
    ...
    public static String CLASS_OFFICE_HOURS_GRID_TA_CELL_SELECTED = "office_hours_grid_ta_cell_selected";
    ...
    private void initTAWorkspaceStyle() {
        ...
        workspaceComponent.getComboBoxesPane().getStyleClass().add(COMBOBOX_PANE_STYLE);
    
        // ADDITIONAL CSS
        workspaceComponent.getCourseDetailsPane().getStyleClass().add(DEFAULT_TAB_PANE_STYLE);
        workspaceComponent.getRecitationDataPane().getStyleClass().add(DEFAULT_TAB_PANE_STYLE);
        workspaceComponent.getScheduleDataPane().getStyleClass().add(DEFAULT_TAB_PANE_STYLE);
        workspaceComponent.getProjectDataPane().getStyleClass().add(DEFAULT_TAB_PANE_STYLE);
    
        workspaceComponent.getCourseInfoHeaderPane().getStyleClass().add(HEADER_LABEL_STYLE);
        workspaceComponent.getSiteTemplateHeaderPane().getStyleClass().add(HEADER_LABEL_STYLE);
        workspaceComponent.getPageStyleHeaderPane().getStyleClass().add(HEADER_LABEL_STYLE);
        workspaceComponent.getScheduleHeaderPane().getStyleClass().add(HEADER_LABEL_STYLE);
        workspaceComponent.getProjDataHeaderPane().getStyleClass().add(HEADER_LABEL_STYLE);
        
        workspaceComponent.getRecitationsPane().getStyleClass().add(SMALL_HEADER_LABEL_STYLE);
        workspaceComponent.getScheduleItemsPane().getStyleClass().add(SMALL_HEADER_LABEL_STYLE);
        workspaceComponent.getProjTeamsPane().getStyleClass().add(SMALL_HEADER_LABEL_STYLE);
        workspaceComponent.getProjStudentsPane().getStyleClass().add(SMALL_HEADER_LABEL_STYLE);
    
        workspaceComponent.getCourseOrderingPane().getStyleClass().add(DEFAULT_INNER_PANE_STYLE);
        workspaceComponent.getCourseOrderingPane2().getStyleClass().add(DEFAULT_INNER_PANE_STYLE);
        workspaceComponent.getCourseOrderingPane3().getStyleClass().add(DEFAULT_INNER_PANE_STYLE);
        workspaceComponent.getRecitationAddOrEditPane().getStyleClass().add(DEFAULT_INNER_PANE_STYLE);
        workspaceComponent.getCalendarBoundariesPane().getStyleClass().add(DEFAULT_INNER_PANE_STYLE);
        workspaceComponent.getScheduleOrderingPane().getStyleClass().add(DEFAULT_INNER_PANE_STYLE);
        workspaceComponent.getProjectOrderingPane().getStyleClass().add(DEFAULT_INNER_PANE_STYLE);
        workspaceComponent.getProjectOrderingPane2().getStyleClass().add(DEFAULT_INNER_PANE_STYLE);
    }
