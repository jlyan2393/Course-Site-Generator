...
public class AppGUI {
	...
	// AND NOW SETUP THEIR EVENT HANDLERS
        ...
        exportButton.setOnAction(e -> {
            try {
                String pathway = fileController.getTAManagerTestFilePath();
                app.getFileComponent().exportData(app.getDataComponent(), app.getCourseDataComponent(), app.getRecitationDataComponent(), app.getScheduleDataComponent(), app.getTeamDataComponent(), app.getStudentDataComponent(), pathway);
